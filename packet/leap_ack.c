...
Packet *genLeapAck(Packet *packet_recv){
    /*wrap into packet*/
    Packet *_packet;
    ...
    snprintf(_packet->packet_type, sizeof(_packet->packet_type), "%s", "1001");
...
int sendLeapAck(int sockfd, Packet *packet_recv){
   ...
   packet_reply = genLeapAck(packet_recv); // msg to be sent back
