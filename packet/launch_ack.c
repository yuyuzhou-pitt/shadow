...
Packet *genLaunchAck(Packet *packet_recv){
    /*wrap into packet*/
    Packet *_packet;
    ...
    snprintf(_packet->packet_type, sizeof(_packet->packet_type), "%s", "0101");
...
int sendLaunchAck(int sockfd, Packet *packet_recv){
   ...
   packet_reply = genLaunchAck(packet_recv); // msg to be sent back
