...
int dumpApp(OptionsProcess *options){
    ...
    options->process.machine[0].port = getRegisterPort(options->process.machine[0].ip, REGISTER_MACHINE_FILE);
    options->process.machine[1].port = getRegisterPort(options->process.machine[1].ip, REGISTER_MACHINE_FILE);
